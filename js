...
*/
    ...
    function Ja() {
        ...
        a = Ia(b);
        return (Fa() ? 0 : r("Opera")) ? a(["Version", "Opera"]) : (Fa() ? 0 : r("Edge")) ? a(["Edge"]) : (Fa() ? Ea("Microsoft Edge") : r("Edg/")) ? a(["Edg"]) : r("Silk") ? a(["Silk"]) : Ha() ? a(["Chrome", "CriOS", "HeadlessChrome"]) : (a = b[2]) && a[1] || ""
    }
    ;function Ka(a, b) {
        if (typeof a === "string")
    ...
    ;function xb(a) {
        ...
        } else if (sb(a) && !Number.isSafeInteger(a))
            throw Error(String(a));
        return BigInt(a)
    }
    ...
    function Yb(a) {
        Kb(a) ? a = xb(Zb(a)) : (a = Mb(a),
        Kb(a) ? a = String(a) : (Eb(a),
        a = Gb()),
        a = xb(a));
        return a
    }
    ...
    ;function nc(a, b) {
        ...
        if (Array.isArray(a)) {
            var c = a[u] | 0;
            a.length === 0 && c & 1 ? a = void 0 : c & 2 || (!b || 4096 & c || 16 & c ? a = oc(a, c, !1, b && !(c & 16)) : (a[u] |= 34,
            c & 4 && Object.freeze(a)));
            return a
        }
        if (a != null && a[gb] === lb)
    ...
    function B(a, b, c, d) {
        ...
        if (e <= f)
            return a[e] = d,
            b;
        d !== void 0 && (f = (b ?? (b = a[u] | 0)) >> 14 & 1023 || 536870912,
        c >= f ? d != null && (a[f + -1] = {
            [c]: d
        }) : a[e] = d);
        return b
    ...
    function Gc(a, b, c, d, e, f, g, h) {
        var k = b;
        f === 1 || (f !== 4 ? 0 : 2 & b || !(16 & b) && 32 & d) ? Hc(b) || (b |= !a.length || g && !(4096 & b) || 32 & d && !(4096 & b || 16 & b) ? 2 : 256,
        b !== k && (a[u] = b),
        Object.freeze(a)) : (f === 2 && Hc(b) && (a = [...a],
        k = 0,
        b = Fc(b, d),
        d = B(c, d, e, a)),
        Hc(b) || (h || (b |= 16),
 ...
 SPDX-License-Identifier: Apache-2.0 
*/
    let zd = globalThis.trustedTypes, Ad;
    function Bd() {
        var a = null;
        if (!zd)
            return a;
    ...
    function Nd() {
        try {
            return Ld ?? (Ld = new Uint32Array(64)),
            Md >= 64 && (crypto.getRandomValues(Ld),
            Md = 0),
            Ld[Md++]
        } catch (a) {
    ...
    function ne(a) {
        var b = oe;
        b.readyState === "complete" || b.readyState === "interactive" ? (de.push(a),
        de.length === 1 && (window.Promise ? Promise.resolve().then(ee) : (a = window.setImmediate,
        ub(a) ? a(ee) : setTimeout(ee, 0)))) : b.addEventListener("DOMContentLoaded", a)
    }
    ...
    function Le(a) {
        a && He && Ke() && (He.clearMarks(`goog_${a.label}_${a.uniqueId}_start`),
    ...
    ;function ug(a, ...b) {
        try {
            a.H && qf(a.g.concat(b), sf(a)).length >= 65536 && Ag(a),
            a.u && !a.A && (a.A = !0,
            Bg(a.u, () => {
                Ag(a)
            }
    ...
    function Fg(a, b, c, d, e, f) {
        if (a.j) {
            ...
            b = fg(b);
            vg(a.i, Eg(a, b));
            if (f === 1 || f === 3 || f === 4 && !a.g.some(h => K(h, 1) === K(g, 1) && K(h, 2) === c))
                a.g.push(g),
        ...
        rd(a, (d, e) => {
            if (c[e]) {
                var f = d = nf(JSON.stringify(d))
                  , g = Nc(d, of, 8);
                Sb(A(f, g)) != null && (g = nf(JSON.stringify(c[e])),
                f = Pc(d, Rc, 4),
                g = kf(Qc(g)),
                Uc(f, g));
                c[e] = y(d)
    ...
    function Zg(a, b, c, d, e=!1) {
        ...
        for (let m of b) {
            ...
            for (let l of a) {
                ...
                h === 8 && b[t] ? (k = nf(JSON.stringify(b[t])),
                h = Pc(l, Rc, 4),
                k = kf(Qc(k)),
                Uc(h, k)) : k && M(Pg).g.get(m)?.has(t) && g.push(k);
                e || (h = t,
                k = m,
                p = d,
                n = M(Pg),
                n.g.has(k) || n.g.set(k, new Map),
                n.g.get(k).has(h) || n.g.get(k).set(h, []),
                p && n.g.get(k).get(h).push(p));
                b[t] = y(l)
            }
        }
    ...
    ;function fi(a, b, c) {
        ...
        ei(b) && (b.setAttribute("data-init-display", b.style.display),
    ...
    var Cj = class {
        ...
        K(a, b, c=.01, d="jserror") {
            ...
            q.error_rep_loaded || (Sd(q.document, this.i),
    ...
    function Hj(a) {
        ...
        if (ad(a, 1) || a.getId() || Cc(a, 4, x, C()).length > 0) {
            ...
            b = b ? new Bj(b,Xc(a, 2, xc),Xc(a, 5, xc),Ij(bd(a, 6))) : null;
        return b
    }
    const Jj = {
        1: 1,
    ...
    ;var Nj = a => {
        ...
        case 2:
            if (a == null)
                ...
                b = D(a, Mh, 1),
                b == null ? b = null : (a = bd(a, 2),
                b = a == null ? null : new Nh({
                    ub: [b],
                    Qb: a
                }));
    ...
    function ik(a, b, c=Uj, d, e) {
        return (ve(b) ? b.msg || ye(b.error) : ye(b)).indexOf("TagError") === 0 ? ((ve(b) ? b.error : b).pbr = !0,
        !1) : hk(a, b, c, d, e)
    }
    function ck() {
        if (sb(q.google_srt)) {
    ...
    rk.prototype.clear = function() {
        ...
        for (let f = 0; f < a.length; f++) {
            ...
            var e = d.indexOf("=");
            e == -1 ? (b.push(""),
            c.push(d)) : (b.push(d.substring(0, e)),
    ...
    var Ck = class extends vk {
        ...
        G() {
            this.A = {};
            this.u && (me(this.j, "message", this.u),
            delete this.u);
            delete this.A;
            delete this.j;
            delete this.g;
    ...
    ;
    var Hk = ({l: a, ca: b, ja: c, yb: d, na: e=!1, oa: f=!1}) => {
        b = Dk({
            l: a,
            ca: b,
            na: e,
    ...
    ;
    function Ik({l: a, ca: b, na: c, oa: d}) {
        if (d = !d)
            d = new Ck(a),
            d = typeof d.j.__tcfapi === "function" || zk(d) != null;
        if (!d) {
            if (c = !c) {
                if (b) {
                    a = jk(a);
    ...
    function Nk(a, b) {
        ...
        b.forEach(e => {
            if ($c(e, kj, 1, nj)) {
                ...
                $c(e, lj, 2, nj) ? Pk(a, $c(e, lj, 2, nj), c) : $c(e, jj, 3, nj) && Qk(a, $c(e, jj, 3, nj), d)
        }
        );
        return new Rk(c,d)
    }
    ...
    const Pk = (a, b, c) => {
        D(b, bi, 2) ? (b = D(b, bi, 2),
        (a = Ok(a, $h(b))) && c.set(ma(a), ai(b))) : D(b, Mh, 1) && (a = Sk(a, D(b, Mh, 1))) && a.forEach(d => {
            d = ma(d);
            c.set(d, 1);
            c.set(d, 4);
            c.set(d, 2);
    ...
    ;function ql(a, b) {
        ...
        b: {
            ...
            var n = [].concat(...hl(e), ...X(e, "body ins.adsbygoogle"))
              , m = [];
            h.Cb && (m = m.concat(X(e, "ins.adsbygoogle[data-ad-hi]")));
            for (let[mc,Ie] of [[h.Ac, p], [h.Gb, z], [h.Dc, N], [h.Bc, ya], [h.Ec, Ra], [h.zc, ob], [h.Cc, Ba], [h.Hb, Ib]])
                p = Ie,
                mc === !1 ? m = m.concat(p) : n = n.concat(p);
            n = pl(n);
            m = pl(m);
            n = n.slice(0);
            for (l of m)
                for (m = 0; m < n.length; m++)
                    (l.contains(n[m]) || n[m].contains(l)) && n.splice(m, 1);
            var l = n;
            l = h.vc ? ol(l) : l;
            h = Xi(e).clientHeight;
    ...
    function tl(a, b, c, d) {
        ...
        a: {
            try {
                ...
                (t = c.Aa) && t.parentNode && (v = t.parentNode,
                v.removeChild(t),
                ei(v) && (v.style.display = v.getAttribute("data-init-display") || "none"));
                t = !1;
                break a
            }
            t = !0
    ...
    var vl = class {
        constructor(a, b, c, d, e, f=!1) {
            ...
            this.B = e || null;
            this.H = f;
            (this.N = d) ? (a = a.document,
            d = E(d, mj, 5, C()),
            d = Nk(a, d)) : d = Nk(a.document, []);
            this.A = d;
            this.G = new Zk;
            this.i = 0;
            this.u = !1
    ...
    function Ll(a) {
        ...
        var c = A(a, 1, void 0, void 0, $b)
          , d = typeof c;
        c != null && (d === "bigint" ? c = String(Jb(64, c)) : Qb(c) ? d === "string" ? (d = Mb(Number(c)),
        Kb(d) ? c = String(d) : (d = c.indexOf("."),
        d !== -1 && (c = c.substring(0, d)),
        d = c.length,
        (c[0] === "-" ? d < 20 || d === 20 && c <= "-9223372036854775808" : d < 19 || d === 19 && c <= "9223372036854775807") || (c.length < 16 ? Eb(Number(c)) : (c = BigInt(c),
        Bb = Number(c & BigInt(4294967295)) >>> 0,
        Cb = Number(c >> BigInt(32) & BigInt(4294967295))),
        c = Gb()))) : c = Zb(c) : c = void 0);
        b = b(c ?? "0");
        a = I(a, 2);
    ...
    function gm(a, b) {
        try {
            ...
            a.vendor = {
                ...
                legitimateInterests: hm(Rl(e), null)
            };
            let f = im(c);
    ...
    function im(a) {
        a.shift();
        for (let b of a)
            if (a = Ua(b).map(c => c.toString(2).padStart(8, "0")).join(""),
            a = new Sl(a),
            Y(a, 3) === 1)
                return hm(Rl(a), null)
    }
    ...
    function nm(a) {
        !a.j || a.l.__uspapi || a.l.frames.__uspapiLocator || (a.l.__uspapiManager = "fc",
        km(a.l, "__uspapiLocator"),
        sa("__uspapi", (b, c, d) => {
            typeof d === "function" && b === "getUSPData" && (b = a.i.j(),
            d({
                version: 1,
                uspString: b ? a.j : "1---"
            }, !0))
    ...
    function pm(a) {
        if (!a?.g() || J(a, 1).length === 0 || E(a, em, 2, C()).length === 0)
            return null;
        var b = J(a, 1);
        try {
            var c = Fl(b.split("~")[0]);
    ...
    var mm = class {
        constructor(a) {
            ...
            this.g = (b = Xl(b.document)) && x(A(b, 2)) != null ? J(b, 2) : null
        }
    }
    ;
    function sm(a) {
    ...
    function zm(a, b) {
        ...
        return b.find(e => {
            if (Ac(e, ij, 7)) {
                ...
                f = Vb(A(e, 1, void 0, xc));
            Ac(e, ij, 7) ? (e = D(e, ij, 7),
            e = bd(e, 2)) : e = 2;
            if (!sb(f))
                return !1;
            switch (e) {
    ...
    function kn(a, b, c, d) {
        ...
        e !== !0 ? a = e : d.google_full_width_responsive === "true" || Yi(c, b) ? (b = U(b),
        a = b - a,
    ...
    ;function rn() {
        var {promise: a, resolve: b} = new qn;
        return {
            promise: a,
            resolve: b
        }
    ...
    function vn(a) {
        ...
        a.google_reactive_ads_global_state.adIntentsPageState == null && (a.google_reactive_ads_global_state.adIntentsPageState = new un)) : a.google_reactive_ads_global_state = new wn;
    ...
    ;
    function yn(a) {
        if (q.google_apltlad || a.google_ad_intent_query || a.google_ad_intents_format)
            return null;
    ...
    function Cn(a, b, c, d, e) {
        ...
        Ac(c, tj, 24) && (d = Mj(a),
        d.availableAbg = !0,
        d.ablationFromStorage = !!D(c, tj, 24)?.g()?.g());
    ...
    ;var Dn = function(a) {
        return b => {
            b = JSON.parse(b);
            if (!Array.isArray(b))
                throw Error("Expected jspb data to be an array, got " + ka(b) + ": " + b);
            b[u] |= 34;
            return new a(b)
        }
    }(class extends L {
    ...
    async function En(a, b) {
        try {
            let c = await globalThis.fetch(Qd(Pd`https://pagead2.googlesyndication.com/getconfig/abg_config`, new Map([["client", a], ["plah", b], ["ama_t", "adsense"], ...Object.entries(pn())])).toString(), {
                method: "GET",
                credentials: "omit"
            });
            if (!c.ok)
                throw Error(`Fetch failed with status: ${c.status}`);
            let d = await c.text();
            if (!d)
                throw Error("AbgConfig endpoint returned empty response.");
            try {
                return Dn(d)
            } catch (e) {
                throw Error(`Error deserializing config: ${einstanceof Error ? e.message : String(e)}`);
            }
        } catch (c) {
            throw c;
        }
    ...
    function co(a, b) {
        ...
        for (var c = [], d = 0; a && d < 25; a = a.parentNode,
        ++d)
    ...
    function wo(a, b) {
        xo(a, b);
        if (b.google_content_recommendation_ui_type === "pedestal" && !S(ii))
            return new to(9,new vo(a,Math.floor(a * 2.189)));
        if (S(li)) {
            var c = xd()
              , d = T(mi)
              , e = T(ki)
    ...
    function xo(a, b) {
        if (a <= 0)
            throw new W(`Invalid responsive width from Matched Content slot ${b.google_ad_slot}: ${a}. Please ensure to put this Matched Content slot into a non-zero width div container.`);
    }
    function yo(a, b) {
    ...
    function Do(a, b, c, d, e) {
        ...
        if (a < 250)
            throw new W(`Fluid responsive ads must be at least 250px wide: availableWidth=${a}`);
        a = Math.min(1200, Math.floor(a));
        if (d && f !== "in-article") {
            f = Math.ceil(d);
            if (f < 50)
                throw new W(`Fluid responsive ads must be at least 50px tall: height=${f}`);
        ...
        if (f !== "in-article" && (d = e.google_ad_layout_key)) {
            ...
            if (d = (c = f.match(/([+-][0-9a-z]+)/g)) && c.length)
                ...
                b = null;
            if (!b)
                throw new W(`Invalid data-ad-layout-key value: ${f}`);
            f = (a + -725) / 1E3;
            c = 0;
            d = 1;
            e = b.length;
            ...
            if (isNaN(f))
                throw new W(`Invalid height: height=${f}`);
            if (f < 50)
                throw new W(`Fluid responsive ads must be at least 50px tall: height=${f}`);
            if (f > 1200)
                throw new W(`Fluid responsive ads must be at most 1200px tall: height=${f}`);
            return new to(11,new ho(a,f))
        }
        d = Bo[f];
        if (!d)
            throw new W("Invalid data-ad-layout value: " + f);
        c = bj(c, b);
        b = U(b);
        b = f !== "in-article" || c || a !== b ? Math.ceil(d(a)) : Math.ceil(d(a) * 1.25);
        return new to(11,f === "in-article" ? new Co(a,b) : new ho(a,b))
    }
    ;var Eo = [{
        F: 970,
        height: 90,
    ...
    ;function No(a, b, c, d, e) {
        e.google_full_width_responsive === "false" ? c = {
            J: a,
            I: 1
        } : b === "autorelaxed" && e.google_full_width_responsive || Oo(b) || e.google_ad_resize ? (b = kn(a, c, d, e),
        c = b !== !0 ? {
            J: a,
            I: b
        } : {
    ...
    function Po(a, b, c, d, e) {
        var {J: f, I: g} = dk(247, () => No(a, b, c, d, e))
          , h = g === !0
          , k = Yd(d.style.width)
          , p = Yd(d.style.height)
          , {aa: n, V: m, D: l, hb: t} = Qo(f, b, c, d, e, h);
        h = Ro(b, l);
        var v, z = (v = Zi(d, c, "marginLeft")) ? `${v}px` : "", N = (v = Zi(d, c, "marginRight")) ? `${v}px` : "";
        v = dj(d, c) || "";
    ...
    function Qo(a, b, c, d, e, f) {
        ...
        var p = Mo(Lo(k), Lo(g));
        if (!p)
            throw new W(`No slot size for availableWidth=${a}`);
        var {aa: n, V: m} = dk(248, () => {
            var l;
            a: if (f) {
    ...
    ;function Uo(a, b, c, d, e) {
        ...
        var {J: g, I: h} = f;
        if (h !== !0 || a === g)
            return new to(12,new ho(a,d),null,null,!0,h,100);
        var {aa: k, V: p, D: n} = Qo(g, "auto", b, c, e, !0);
    ...
    ;function Vo(a) {
        ...
        if (b === "link")
            return 4;
        if (b === "fluid")
            return a.google_ad_layout === "in-article" ? (Wo(a),
            1) : 8;
    ...
    function Yo(a, b, c, d, e) {
        ...
        switch (a) {
        case 5:
            let {J: g, I: h} = dk(247, () => No(b, d.google_ad_format, e, c, d));
            h === !0 && b !== g && on(e, c);
    ...
    function bp(a, b) {
        ...
        for (let d of a.attributes)
            /data-/.test(d.name) && (a = ua(d.name.replace("data-matched-content", "google_content_recommendation").replace("data", "google").replace(/-/g, "_")),
            b.hasOwnProperty(a) || (c = ap(a, d.value),
            c !== null && (b[a] = c)));
    ...
    function ep(a, b, c, d) {
            ...
            if (f > 0 && e > f) {
                ...
                if (e) {
                    ...
                    if (k)
                        ...
                        throw new W("No slot size for availableWidth=" + f);
                }
        ...
        if (S(ni) || U(c) < 488) {
            ...
            if (d = en(f.location, "google_responsive_slot_preview") || Im(f, 1, d, e))
                b: if (b.google_reactive_ad_format || b.google_ad_resize || Vo(b) || hn(a, b))
                    d = !1;
                else {
        ...
        if (g = Vo(b))
            ...
            if (hn(a, b)) {
                ...
                gn(a.style, b);
            c.location && c.location.hash === "#gfwmrp" || b.google_responsive_auto_format === 12 && b.google_full_width_responsive === "true" ? Xo(10, a, b, c, !1) : Math.random() < .01 && b.google_responsive_auto_format === 12 && (a = kn(a.offsetWidth || parseInt(a.style.width, 10) || b.google_ad_width, c, a, b),
            a !== !0 ? (b.efwr = !1,
    ...
    function gp(a) {
        ...
        if (b !== 2 && hp(c, d, e))
            ...
            if (jp(d))
                q.console && q.console.warn("Adsbygoogle tag with data-reactive-ad-format=" + String(d.google_reactive_ad_format) + " is deprecated. Check out page-level ads at https://www.google.com/adsense");
            else {
                if (b === 2) {
                ...
                dk(164, () => {
                    var {Fb: k, Yb: p} = Fn(e, d);
                    c.appendChild(p);
                    bo(d);
                    sb(d.google_reactive_sra_index) && d.google_ad_unit_key || (d.google_ad_unit_key = co(c, d),
                    d.google_ad_dom_fingerprint = In(e, c),
                    d.override_ady = eo(c),
                    d.override_adx = fo(c));
                    ...
                    Zn(e, () => {
                        ...
                        if (!l || !l.isConnected)
                            if (l = e.document.getElementById(String(d.google_async_iframe_id) + "_host"),
                            l == null)
                                throw Error("no_div");
                        (t = e.google_sa_impl({
                            pubWin: e,
            ...
            e.document.createComment && c.appendChild(e.document.createComment("No ad requested because of display:none on the adsbygoogle tag"))
    }
    function hp(a, b, c) {
        var d = Bm(c);
        !d?.Va || b.google_adtest === "on" || w(a.className) && RegExp("(\\W|^)adsbygoogle-noablate(\\W|$)").test(a.className) ? d = !1 : d.Wa ? (a = aj(a, c),
        c = Xi(c).clientHeight,
        d = ((c === 0 ? null : a / c) || 0) >= d.Wa) : d = !0;
        return d
    }
    function ip(a, b, c, d) {
        ...
        Bm(c)?.Vb === "slot" && (Xd(a.getAttribute("width")) !== null && a.setAttribute("width", "0"),
    ...
    function Vp(a) {
        Bg(a.j, () => {
            var b = Sp(a);
            b = G(b, 12, Qf, a.B);
            a.i && !a.state.le.includes(3) && (a.state.le.push(3),
            wg(a.g, b))
        }
        , 9)
    }
    ...
    function mq(a, b) {
        ...
        for (let[f,g] of a[1].entries()) {
            var d = f
              , e = g;
            let {ob: h, kb: k, lb: p} = e[e.length - 1];
            c.set(d, h + k * p)
        }
        for (let f of b)
            for (let g of E(f, xp, 2, C())) {
                if (wp(g).length === 0)
                    continue;
                b = Vb(A(g, 8)) ?? 0;
                !K(g, 4) || K(g, 13) || K(g, 14) || (b = c.get(K(g, 4)) ?? 0,
                d = (Vb(A(g, 1)) ?? 0) * wp(g).length,
                c.set(K(g, 4), b + d));
                d = [];
    ...
    function qq(a, b) {
        var c = M(Jg).T
          , d = jf(D(b.ua, bf, 3), c);
        if (!d.success)
            return Hg(a.R, D(b.ua, bf, 3), b.la, b.W.getId(), d),
            !1;
        if (!d.value)
            return !1;
        c = jf(D(b.W, bf, 3), c);
        return c.success ? c.value ? !0 : !1 : (Hg(a.R, D(b.W, bf, 3), b.la, b.W.getId(), c),
        !1)
    }
    function rq(a, b, c) {
        a.g[c] || (a.g[c] = []);
                ...
                if (k !== void 0) {
                    for (let z of p) {
                        ...
                        if (!qq(a, z))
                            continue;
                        p = K(z.ua, 13);
                        p !== 0 && p !== void 0 && (n = a.j[String(p)],
                        n !== void 0 && n !== z.W.getId() ? Gg(a.R, a.j[String(p)], z.W.getId(), p) : a.j[String(p)] = z.W.getId());
                        h.push(z.W)
                    }
                    Oc(v, Wf) !== 0 && (dd(v, 3, k),
                    g.push(v))
    ...
    ;function zq({Db: a, T: b, config: c, wb: d=fq(), xb: e=0, R: f=new Ig(Ml(D(a, zp, 5)?.g()) ?? 0,Ml(D(a, zp, 5)?.j()) ?? 0,D(a, zp, 5)?.A() ?? !1), pa: g=lq(E(a, yp, 2, C(pb)))}) {
        d.hasOwnProperty("init-done") ? (ch(12, d, () => {}
        )(E(a, yp, 2, C()).map(h => y(h))),
        ch(13, d, () => {}
        )(E(a, mf, 1, C()).map(h => y(h)), e),
        b && ch(14, d, () => {}
        )(b),
        Aq(e, d)) : (uq(new vq(g,e,f,c), d),
        dh(d),
        eh(d),
        fh(d),
        Aq(e, d),
        Zg(E(a, mf, 1, C(pb)), [e], f, void 0, !0),
        Kg = Kg || !(!c || !c.Ib),
        yq(kq),
        b && yq(b))
    }
    ...
    function Pq(a, b, c) {
        ...
        case 2:
            let d = Rq(a);
            if (d)
                return c.some(f => Sq(d, f));
            break;
        case 1:
            let e = Tq(a);
            if (e)
                return b.some(f => Sq(e, f))
        }
        return !1
    }
    function Qq(a) {
    ...
    function fr(a) {
        if (!a.Qa) {
            ...
            window.LayoutShift && (b += Mq("cls", a.G),
            b += Mq("mls", a.O),
            b += Lq("nls", a.fa),
            window.LayoutShiftAttribution && (b += Mq("cas", a.B),
            b += Lq("nas", a.Pa),
            b += Mq("was", a.Ua)),
            b += Mq("wls", a.va),
            b += Mq("tls", a.Ta));
            window.LargestContentfulPaint && (b += Lq("lcp", a.Na),
            b += Lq("lcps", a.Ma));
    ...
    function mr(a) {
        ...
        for (let d = 0, e = b[d]; d < b.length; e = b[++d]) {
            var c = e;
            if (lr(c) && c.dataset.adsbygoogleStatus !== "reserved" && (!a || e.id === a))
                return e
        }
        return null
    }
    ...
    function ur(a) {
        ...
        rd(a, (b, c) => {
            ej[c] || (delete a[c],
            q.console.warn(`AdSense head tag doesn't support ${c.replace("google", "data").replace(/_/g, "-")} attribute.`))
        }
        )
    }
    function vr(a, b) {
        ...
        if (c) {
            ...
            bp(c, d);
            ur(d);
            d.google_ad_intent_query && (d.google_responsive_auto_format = cp(d),
    ...
    function yr(a) {
        ...
        if ((a = We(c, "client") || a.getAttribute("data-ad-client") || "") && a !== b.google_ad_client)
            throw new W(`Warning: Do not add multiple property codes with AdSense tag to avoid seeing unexpected behavior. These codes were found on the page ${a}, ${String(b.google_ad_client)}`);
    }
    function Ar(a) {
        if (typeof a === "object" && a != null) {
            if (w(a.type))
                return 2;
            if (w(a.sound) || w(a.preloadAdBreaks) || typeof a.h5AdsConfig === "object")
                return 3
        }
        return 0
    }
    function tr(a, b, c, d, e, f) {
        if (a == null)
            throw new W("push() called with no parameters.");
        var g = M(Yp);
        Up(g, k => {
            var p = Kf(k);
            Yc(p, 3) || (k = Kf(k),
        ...
        if (h !== 0)
            ...
            d.adsbygoogle_execution_start_time = sh),
            hr == null)
                Br(a),
                ir.push(a);
            else if (h === 3) {
            ...
            b.google_ad_output === "js")
                ...
                if (c.hasAttribute("data-require-head") && !Z(q).head_tag_slot_vars)
                    throw new W("AdSense head tag is missing. AdSense body tags don't work without the head tag. You can copy the head tag from your account on https://adsense.com.");
                if (!b.google_ad_client)
                    throw new W("Ad client is missing from the slot.");
                if (e = (Z(O).first_tag_on_page || 0) === 0 && yn(b))
                    Up(g, k => {
                        var p = Kf(k);
                        Yc(p, 5) || (k = Kf(k),
                        fd(k, 5))
    ...
    function Er(a, b) {
        ...
        !b)
            throw new W("All 'ins' elements in the DOM with class=adsbygoogle already have ads in them.");
        if (c) {
            c = O;
            try {
    ...
    function Hr(a) {
        Number(a) ? Z(O).pause_ad_requests = !0 : (Z(O).pause_ad_requests = !1,
        a = () => {
            ...
            if (!e.BGtEY) {
                ...
                if (!Ga() || va(Ja(), 11) >= 0) {
                    ...
                    if (!h || !h.loaded) {
                        ...
                        if (h)
                            for (let l of ["requestNonPersonalizedAds", "pauseAdRequests", "onPaidEvent"])
                                h[l] !== void 0 && (p[l] = h[l]);
                        nr(h, k, g, n, m);
                        e.adsbygoogle = p;
                        h && (p.onload = h.onload)
